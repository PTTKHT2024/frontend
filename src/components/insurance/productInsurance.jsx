...
const ProductInsurance = () => {
  return (
    <>
      <div className="mt-[96px] box-content">
        ...
        <div className="w-[1200px] max-w-full my-14 mx-auto">
          ...
          <div className="m-0 mt-14 text-base leading-[150%] text-subInformationColor">
            <p className="mt-0 mb-4">
              ...
              riêng, xin vui lòng xem kỹ chi tiết sản phẩm tại Quy tắc bảo hiểm
              xe cơ giới và Giấy chứng nhận bảo hiểm Toyota.
            </p>
            <p className="mt-0 mb-4">
              - Trong mọi trường hợp giảm/thưởng/chiết khấu, phí bảo hiểm không
              được phép thấp hơn phí tối thiểu của Bộ Tài Chính.
            </p>
          </div>
          <div className=""></div>
        </div>
