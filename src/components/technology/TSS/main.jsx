  ...
  return (
    <>
                ...
                {selection === 'video' ? (
                  ...
                  <div>
                    <img
                      ...
                      className="w-80 h-44"
                    />
                    <h3 className="text-black text-base mt-5 hover:font-semibold cursor-pointer">Cross2</h3>
                  </div>
                )}
              </div>
              <ThreeButton />
      ...
      {videoIndex !== null && (
        <div
          ref={videoRef}
          className="fixed top-0 left-0 right-0 bottom-0 z-10 bg-gray-900 bg-opacity-75 flex justify-center items-center"
          onClick={handleClose}
        >
          <div
            className="relative bg-black w-[980px] h-[600px] pt-10 transition duration-300 ease-in-out"
