  ...
  return (
    <div>
      ...
      <div className={`tab ${activeTab === 'Tab2' ? 'active' : ''}`}>
        ...
        <p>
          Nhằm đảm bảo xe của bạn vận hành an toàn và ổn định,
          chúng tôi khuyên bạn nên đưa xe đi bảo dưỡng định kỳ tại các đại lý và
          trạm dịch vụ ủy quyền Toyota trên toàn quốc.
        </p>
        <div className="img-container">
          <img
